  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          마감 3분 미만을 남기고 유효한 새 입찰이 접수되면 해당 상품의 마감 시각은
          서버 시각을 기준으로 다시 3분 뒤로 연장될 수 있습니다. 연장 시간에는 기존
          참여자만 입찰할 수 있으며, 화면의 연장 배지와 남은 시간으로 이를 알립니다.
        </p>
        <p className="mt-3">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          현재 결제수단은 회사가 결제 화면에 안내하는 공용 계좌로의 계좌이체입니다.
          회원이 계좌번호 보기를 선택하면 입금 진행 상태로 접수되며, 회사는 실제
          입금액을 확인한 뒤 결제 완료로 확정합니다. 입금 확인 전에는 결제 완료 상품의
          배송을 신청할 수 없습니다.
        </p>
        <p className="mt-3">
          결제 화면에 표시된 서버 기준 입금기한까지 입금이 확인되지 않으면 해당 낙찰은
          미입금으로 취소되고 경고가 기록될 수 있습니다. 누적 경고에 따른 입찰 제한은
          회원 화면과 운영 정책에 따라 적용되며, 기존 밴드 회원으로 별도 표시된
          결제기한 특례 회원에게는 미입금 기한과 그에 따른 경고·제재를 적용하지 않습니다.
        </p>
        <p className="mt-3">
          미입금 취소 후 차순위 입찰자에게 12시간의 구매 기회를 제안할 수 있습니다.
          차순위 제안은 회원이 명시적으로 수락하기 전에는 구매계약이나 결제 의무가
          발생하지 않으며, 무응답 또는 거절만으로 경고를 부과하지 않습니다. 수락한
          회원에게는 화면에 표시된 동일한 서버 결제기한이 적용됩니다.
        </p>
        <p className="mt-3">
          향후 PG 결제가 활성화되면 결제 화면에 표시되는 카드·간편결제·가상계좌 등
          제공 수단과 해당 결제사업자의 절차를 따릅니다. 결제 오류나 중복 결제가
          확인되면 운영팀이 확인 후 취소 또는 환급합니다.
        </p>
      </>
    ),
  },
