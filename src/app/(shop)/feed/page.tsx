...
export default async function FeedPage() {
  ...
  return <><StoreMallNavigator stores={stores} /><div className="flex items-start gap-10"><AuctionFilterSidebar saleType="auction" surface="desktop" /><Suspense fallback={<div className="min-w-0 flex-1" />}><AuctionFeedGrid className="min-w-0 flex-1" saleType="auction" surface="desktop" title="오늘의 실시간 경매" /></Suspense></div></>;
}
