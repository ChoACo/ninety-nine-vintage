...
export default async function FeedPage() {
  ...
  return <><LoginReturnScrollRestorer /><AuctionFilterSidebar saleType="auction" surface="desktop" /><Suspense fallback={<div className="min-h-64" />}><AuctionFeedGrid saleType="auction" surface="desktop" title="오늘의 실시간 경매" /></Suspense></>;
}
