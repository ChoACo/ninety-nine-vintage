  ...
  return (
    <div className="space-y-16" data-home-presentation="desktop">
      ...
      <section aria-label="나인티 나인 이용 특징" className="grid grid-cols-3 gap-4">
        ...
        <article className="rounded-3xl border border-emerald-500/40 bg-emerald-950 p-7 text-emerald-50 dark:text-emerald-100"><div className="flex items-start justify-between gap-3"><span className="grid size-11 place-items-center rounded-2xl bg-emerald-900"><Package size={20} strokeWidth={1.75} /></span><span aria-describedby="combined-shipping-help" className="rounded-full bg-emerald-400 px-3 py-1.5 text-[10px] font-black text-emerald-950">배송비 0원 세이브</span></div><p className="mt-6 text-base font-black">14일 무료 보관 & 묶음 배송</p><p className="mt-2 text-xs leading-5 text-emerald-100/75">상품을 보관함에 모아 한 번에 배송받고 배송비를 절약하세요.</p><p className="sr-only" id="combined-shipping-help">여러 날 구매한 상품을 한 번에 받아 배송비를 줄일 수 있습니다.</p></article>
      </section>
