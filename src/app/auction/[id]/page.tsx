...
export default async function AuctionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!item) notFound();
  return <div className="grid grid-cols-12 gap-12"><div className="col-span-7"><ItemGallery item={item} /><ConditionReport item={item} /></div><StickyBidPanel item={item} /></div>;
}
