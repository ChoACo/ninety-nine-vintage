    ...
    <div className="space-y-12">
      <section className="grid min-h-[560px] overflow-hidden bg-ink text-paper lg:grid-cols-[1.2fr_.8fr]">
        <div className="flex flex-col justify-between p-7 md:p-12 lg:p-16">
          <div>
            ...
            <h1 className="mt-16 max-w-3xl text-5xl font-black leading-[.95] tracking-[-.1em] sm:text-7xl lg:text-[7.4rem]">시간을<br />다시 입는<br /><span className="text-zinc-500">경매.</span></h1>
          </div>
          <div className="mt-16 flex max-w-lg items-end justify-between gap-8">
      ...
      <section className="mt-20">
        <div className="mb-6 flex items-end justify-between border-b border-ink pb-4">
          ...
          <Link className="text-xs font-bold underline" href="/shop">SHOP ALL</Link>
        </div>
