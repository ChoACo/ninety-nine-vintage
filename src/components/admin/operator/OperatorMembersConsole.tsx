...
export function OperatorMembersConsole() {
  ...
  return <div className="space-y-8">
    <SectionHeading action={<div className="text-right"><p className="font-mono text-3xl font-bold">{members.length}</p><p className="text-[10px] text-muted">KAKAO MEMBERS</p></div>} description="상담·주문·배송 이력을 확인하고 회원 상태와 배송 이용권을 관리합니다." eyebrow="OPERATOR / MEMBER OPERATIONS" title="회원 관리" variant="page" />
