...
export function OwnerOperationsConsole() {
  ...
  return <div className="space-y-8">
    ...
    <section className="border border-line p-6"><p className="text-xs font-bold">입금 원장 처리</p><p className="mt-2 text-xs leading-5 text-muted">입금자명·입금액·메모를 기록하고, 부분입금과 취소 원장을 주문 단위로 관리합니다.</p><Link className="mt-5 inline-flex bg-ink px-5 py-3 text-xs font-bold text-paper" href="/admin/operator/orders">입금 원장 열기</Link></section>
