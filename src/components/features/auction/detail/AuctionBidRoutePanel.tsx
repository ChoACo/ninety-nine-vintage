...
export function AuctionBidRoutePanel({ bidIncrement, currentPrice, minimumBid, productId, productTitle }: AuctionBidRoutePanelProps) {
  ...
  return (
    ...
    <section className="mx-auto w-full max-w-xl rounded-3xl border border-white/10 bg-paper p-1 shadow-xl shadow-black/5 md:p-3">
      ...
      <div className="mt-2 flex h-13 items-center rounded-2xl border border-ink px-4 shadow-sm transition-all duration-300 focus-within:ring-4 focus-within:ring-black/5">
