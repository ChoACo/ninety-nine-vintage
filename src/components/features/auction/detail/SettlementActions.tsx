...
export function SettlementActions({ productId }: SettlementActionsProps) {
  ...
  return (
    <div className="mt-6 border-t border-zinc-200 pt-5">
      ...
      <button className="h-10 w-full border border-zinc-950 text-xs font-bold transition-colors hover:bg-zinc-950 hover:text-white disabled:opacity-50" disabled={busy !== null} onClick={startManualTransfer} type="button">{busy === "manual" ? "계좌 확인 중..." : "계좌이체 안내"}</button>
