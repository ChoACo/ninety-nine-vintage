...
export function AuthStatus() {
  ...
  if (!session) return <a aria-label="카카오 로그인" className="inline-flex h-10 shrink-0 items-center gap-2 border border-line px-3 text-[11px] font-bold whitespace-nowrap transition-colors hover:border-ink hover:bg-surface" href="/api/auth/kakao/start?returnTo=%2Faccount"><LogIn size={15} /> 카카오 로그인</a>;
