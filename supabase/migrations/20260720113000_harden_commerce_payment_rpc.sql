-- Keep payment settings and transfer snapshots behind security-definer RPCs.
-- The underlying tables intentionally revoke direct service-role/table access.
...
revoke all on function public.get_commerce_payment_status()
from public, anon, authenticated, service_role;
grant execute on function public.get_commerce_payment_status()
to authenticated;
